...
(function(root, factory) {
    ...
    var document = win.document,
        ...
        Util = {
            ...
            /**
             * Determine whether the target is focussable
             * Private
             * @method focus
             * @param  {Object} el Target element
             * @return {Boolean} true if focussable, else false
             */
            focus: function(el) {
        ...
        Events = {
            ...
            unbind: function(selector, target, event, callBack, index) {
                var bindedEvt, eventName = selector + index + event;
    ...
    DOM.prototype = {
        ...
        fire: function(event, callBack) {
            ...
            if ('createEvent' in document) {
                while (l--) {
                    ...
                    this[l].dispatchEvent(e);
                }
            } else {
                while (l--) {
                    e = document.createEventObject();
                    this[l].fireEvent('on' + event, e);
                }
            }
            return this;
        },
        ...
        wrap: function(html) {
            this[0].parentNode.insertBefore(html, this[0]);
            html.appendChild(this[0]);
        },
         ...
         */
        prev: function() {
            return Util.sibling(this[0], 'previousSibling');
        },
        /**
        ...
        prevAll: function(selector) {
            var elem = Util.siblingsList(this[0], 'previousSibling');
            elem = Util.filter(elem, selector);
            return dom(elem);
        },
        /**
         ...
         */
        siblings: function() {
            var elem = Util.siblings((this[0].parentNode || {}).firstChild, this[0]);
            if (1 < elem.length)
        ...
        children: function(selector) {
            var elem = Util.siblings(this[0].firstChild);
            elem = selector ? Util.filter(elem, selector) : elem;
            if (1 < elem.length)
                elem = Util.uniqueSort(elem);
            return dom(elem);
        },
        ...
        /**
         * Find whether the element is hidden or not
         * @method isHidden
         * @return {Boolean} [description]
         */
        isHidden: function() {
            return Util.isHidden(this[0]);
        },
        /**
         * Showing and hiding an element can be achieved by toggling its display style:
         * @method toggle
    ...
    var dom = function(selector) {
        ...
        if (!element.length)
            throw selector + ' Node not found in DOM.';
     ...
     */
    dom.trim = dom.prototype.trim = function(str) {
     ...
     */
    dom.parseJSON = dom.prototype.parseJSON = JSON.parse;
    /**
     ...
     */
    dom.stringify = dom.prototype.stringify = JSON.stringify;
    /**
     ...
     */
    dom.clean = dom.prototype.clean = function(node) {
        node = node ? $(node)[0] : document;
        var n = 0,
            child,
